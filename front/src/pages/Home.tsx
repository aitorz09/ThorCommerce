...
export const Home = () => {
  ...
  return (
    ...
    <Header></Header>
      ...
      <h2 className='text-center my-6 text-4xl'>Categorias</h2>
      <section className='flex justify-around my-10 '>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <Link to='/kids' > <img className='w-44 rounded-full' src={kidimg} alt="" /></Link>
            </div>
          </section>
          ...
          {products.map((product:Product) =>{
            return (
              <div key={product.id} className='flex flex-col gap-2 my-10 place-items-center' >
                ...
                <img className='w-44 rounded-xl' src={`${url}/images/${product.images}`} alt="" />
